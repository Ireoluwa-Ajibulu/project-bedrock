...
resource "aws_iam_policy" "dev_view_s3_put" {
  ...
  description = "Allow dev-view user to upload to assets bucket"
...
resource "aws_iam_user_policy_attachment" "dev_view_s3_put" {
  user       = aws_iam_user.dev_view.name
...
# CloudWatch IAM role for FluentBit
...
# App IAM role for accessing DynamoDB and Secrets Manager
...
resource "aws_iam_policy" "app" {
  ...
  description = "Allow app to access DynamoDB and Secrets Manager"
